...
\author{Team 7 --- CSE 578: Data Visualization}
\affiliation{%
...
%% Replace the single \author block above with one block per teammate
%% if you want individual names listed. Example for two members:
%
% \author{Member One}
